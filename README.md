...
| ---------- | ------------------------------------------------------------------------------------------- |
|            |                                                                                             |
| Завдання:  | 1.Побудувати круглий фонтан з підсвіткою з радіусом 8 та зі сферою води в точці (0; -54; 0) |
...
Побудуємо багатоярусний фонтан с картинки:
...
## Водоспад всередині гірки

|            |                                                                                                |
| ---------- | ---------------------------------------------------------------------------------------------- |
| Завдання   | 1.Побудувати всередині гірки водоспад, висоту гірки потрібно вказати за допомогою змінної num1 |
| Код:       | ![](.gitbook/assets/127.png)                                                                   |
| Результат: | ![](.gitbook/assets/126.png)                                                                   |
